...
public class TestRcbvhRender
{
	...
	public static void main(String[] args)
	{
		...
		// models.put("models\\jonesy\\", "jonesy.obj");
			...
			for (String path : models.keySet())
			{
				...
				for (Integer resolutionWidth : resolutions.keySet())
				{
					...
					for (float zoom = startZoom; zoom <= endZoom; zoom += zoomStep)
					{
						...
						Vector3f at = Vector3fUtil.add(centerOfVoxel, new Vector3f(0, 0, 0));
						Vector3f light = Vector3fUtil.add(centerOfVoxel, new Vector3f(-10, 20, 20));
						// Demo2
						...
						// Vector3f(0,
						// (parentNodeVoxel.getMaxY() -
						// parentNodeVoxel.getMinY()) / 4.0f, 0));
						// Vector3f light = Vector3fUtil.add(eye, new
						// Vector3f(0, 0, 0));
